...
public class GetappId2 extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            /* 接続先のURLを決める*/
            // エンドポイントのURL
            String endpoint = "https://api.apigw.smt.docomo.ne.jp/naturalCharaConv/v1/registration?APIKEY=" + APIKEY;
            ...
            Log.v("GetappId2", "レスポンスデータ = " + responseData);
