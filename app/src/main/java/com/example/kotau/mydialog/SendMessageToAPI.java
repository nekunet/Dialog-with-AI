...
public class SendMessageToAPI extends AsyncTask<String, Void, String>{
    ...
    protected String doInBackground(String... params) { // String... は String[] みたいなもん
        ...
        try {
            /* 接続先のURLを決める*/
            // エンドポイントのURL
            String endpoint = "https://api.apigw.smt.docomo.ne.jp/naturalChatting/v1/dialogue" + "?APIKEY=" + APIKEY;
            ...
            Log.v("SendMessageToAPI", "レスポンスデータ = " + responseData);
